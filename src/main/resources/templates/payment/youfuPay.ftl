    ...
    <div class="paylo">
        <form id="form" name="form" method="post" action="">
            ...
            <div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input name="cvv2" id="cvv2" class="weui-input CVV2" type="number" autocomplete="off" placeholder="CVV2，卡背后三位"/>
                </div>
            </div>

            <#if channelNo=='YOUFUTM2'>
        ...
        function sendSms(obj) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    var code = data.code;
                    if (code == "0000") {
                        var orderNoSure = data.result.orderNoSure;
                        $("#orderNoSure").val(orderNoSure);
                        showMsg2("短信验证码发送成功");
                    } else {
                        var message = data.message;
                        showMsg2(message);
