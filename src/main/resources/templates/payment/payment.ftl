        ...
        <div class="weui-cell__bd">
            <div class="nav_rig">
                <div class="nav_cen">
                    ...
                    <div class="nav_last"><span>尾号${bankCardNo}</span><span style="margin-left:0.666667rem;">信用卡</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="paylo">
        <form id="form" name="form" method="post" action="">
            ...
            <#--<div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input name="usernam" id="usernam" class="weui-input usernam" type="text" disabled="disabled"
                           placeholder="请输入姓名"/>
                </div>
            </div>
            <div class="weui-cell">
                <div class="weui-cell__hd"><label class="weui-label" style="letter-spacing:0;">身份证号</label></div>
                <div class="weui-cell__bd">
                    <input name="idcar" id="idcar" class="weui-input idcar" type="text" placeholder="请输入身份证号"/>
                </div>
            </div>
            <div class="weui-cell">
                <div class="weui-cell__hd"><label class="weui-label">手机号</label></div>
                <div class="weui-cell__bd">
                    <input name="phone" id="phone" class="weui-input phone" type="tel" placeholder="请输入手机号"/>
                </div>
            </div>-->
            ...
            <div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input name="validThru" id="validThru" class="weui-input period" type="number"
                           placeholder="有效期，月/年(如09/15输入0915)"/>
                </div>
            </div>
            <div class="weui-cell">
                <div class="weui-cell__hd"><label class="weui-label">CCV2</label></div>
                <div class="weui-cell__bd">
                    <input name="cvv2" id="cvv2" class="weui-input CVV2" type="number" placeholder="请输入CVV2,卡后背三位"/>
                </div>
            </div>
    ...
    <#if sms=='1'>
        ...
        function sendSms(obj) {
            ...
            $.ajax({
                ...
                url: "quickPaySendSms",
                contentType: "application/x-www-form-urlencoded; charset=UTF-8",
                data: {"outTradeNo":formData.outTradeNo,"jsonParams":"{}"},
                success: function (data) {
                    var code = data.code;
                    if (code == "0000") {
