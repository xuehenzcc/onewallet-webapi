...
public class StringReplaceUtil {
     ...
     * @return
     */
    public static String userNameReplaceWithStar2(String userName) {
        if(StringUtils.isEmpty(userName))
            return "";

        String start = StringUtils.substring(userName, 1, 2);
        userName = StringUtils.replace(userName, start, "*");
        return userName;
    }
    ...
    public static String phoneReplaceWithStar(String phone) {
        ...
        String start = StringUtils.substring(phone, 3, 7);
        phone = StringUtils.replace(phone, start, "****");
        return phone;
    }

    public static void main(String[] args) {
        String a = "孔令涛";
        String b = StringUtils.substring(a, 1, 2);
        a = StringUtils.replace(a, b, "*");
        System.out.print(a);
    }
}
