...
@Service
public class ZheyangLDQuickPayImpl implements QuickPay {
    ...
    public Map<String, Object> quickPay(WalletUserInfo userInfo, WalletTradeRecords tradeRecords, ZzlmChannel channel, ZzlmChannelMer channelMer, WalletBankCard bankCard) throws Exception {
        ...
        obj.put("notifyUrl", channel.getNoticeUrl());
        obj.put("frontUrl", channel.getReturnUrl());
        obj.put("fastpayFee", channelMer.getDeductRate());//交易手续费 0.5%传0.5
        obj.put("agencyType", "liandong");//联动优势（支持招商）
